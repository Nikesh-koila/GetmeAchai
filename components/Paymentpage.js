    ...
    <>
      ...
      <div className="coverpic w-full flex justify-center relative ">
        ...
        <div className="profilepic absolute -bottom-14 ">
          <img
            src={currentUser.profilepic ? currentUser.profilepic : "/profile.png"}
            alt="profile pic"
          ...
          {!currentUser.razorpayid || !currentUser.razorpaysecret ? (
            ...
            <>
              ...
              <div className="flex flex-col gap-3 items-center">
                ...
                <button
                  type="button"
                  className="text-white bg-gradient-to-r from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-14 py-2.5 text-center me-2 mt-2 disabled:from-gray-200 disabled:to-gray-200 disabled:opacity-30 disabled:text-gray-400"
                  disabled={paymentform.name?.length < 3 || paymentform.message.length < 5 || paymentform.amount?.length < 2}
                  onClick={() => {
              ...
              <div className="flex gap-3 mt-8">
                <button
                  className="bg-slate-700 p-2 rounded-md focus:ring-2 focus:ring-slate-600 disabled:opacity-40"
